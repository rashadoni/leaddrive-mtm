...
Следующий автономный production-инкремент — **GAP-003: полная карточка и форма
контакта**. После него главы GAP-004…GAP-016 выполняются последовательно с тем же
gate: tests/build → PR/CI → merge → production smoke → Android runtime обеих ролей.
