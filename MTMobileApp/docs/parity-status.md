...
- **SWM-14 Задачи** — ✅ список, статусы, старт/завершение, durable мутации + офлайн, **detail-экран + timeline жизненного цикла**, **Manager-редактирование** (title/description/priority, gated TEAM_DECIDE + scope) · ❌ recurrence-авторинг, dueDate-редактирование (нужен date-picker), файлы, progress, review/return, дублирование, bulk.
