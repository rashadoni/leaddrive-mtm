...
Опорный трекер до полной функциональной близости к 18 экранам эталонной CRM.
Критерий «полностью» — `reference-parity-register.md` (роли/RBAC, workflow,
...
зафиксированы в `mtm-reference-parity-gaps.md`.
...
- [ ] **SWM-07 Мои организации** — фильтры эталонной CRM, last-visit/coverage, saved views, map/list toggle. `[код]` (+ карта → гейт).
