 ...
 *
 * Mirrors leaddrive-v2/src/lib/mtm/photo-watermark/compose-watermark-text.ts —
 * edit both together until a shared lib exists.
 *
 * Time formatting uses local Date fields (getDate/getHours/...) because the
 * watermark is what the agent sees on their device.
 */
