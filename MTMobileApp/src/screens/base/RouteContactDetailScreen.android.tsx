...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: fieldTheme.color.primarySoft, fontSize: 11, fontWeight: "900", letterSpacing: 0.8, textTransform: "uppercase", marginTop: fieldTheme.space.lg },
  ...
  sectionTitle: { color: fieldTheme.color.inkMuted, fontSize: 12, fontWeight: "900", letterSpacing: 0.7, textTransform: "uppercase" },
  ...
  rowLabel: { color: fieldTheme.color.inkMuted, fontSize: 11, fontWeight: "800", textTransform: "uppercase" },
