...
const styles = StyleSheet.create({
  ...
  hero: { padding: 20, borderRadius: 20, backgroundColor: "#D9F1E8", borderWidth: 1, borderColor: "#B7DDCE" }, heroEyebrow: { color: "#08705A", fontSize: 10, fontWeight: "900", letterSpacing: 0.7, textTransform: "uppercase" }, heroTitle: { color: "#13231F", fontSize: 20, fontWeight: "900", marginTop: 5 }, heroBody: { color: "#5E7069", fontSize: 12, lineHeight: 18, marginTop: 5 },
